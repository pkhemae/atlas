...
const CHIP =
  "flex size-9 items-center justify-center rounded-full transition-[color,background-color,scale] active:scale-[0.96] disabled:pointer-events-none disabled:opacity-50";
...
export function Dock({
  ...
  return (
    ...
    >
      <div
        data-tauri-drag-region
        className="animate-in fade-in zoom-in-95 flex h-12 items-center gap-2.5 rounded-full bg-zinc-900/95 pr-1.5 pl-4 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_8px_24px_rgba(0,0,0,0.5)] duration-300"
      >
        <span
          data-tauri-drag-region
          className={cn(
            ...
            "font-[Menlo,Consolas,monospace] text-base font-semibold text-red-500 tabular-nums transition-opacity",
